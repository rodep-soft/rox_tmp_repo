...
MecanumWheelControllerNode::MecanumWheelControllerNode() : Node("mecanum_wheel_controller"), motor_controller_(this->get_logger()) {
    declare_parameters();
    get_parameters();
...
void MecanumWheelControllerNode::brake_service_callback(const std::shared_ptr<std_srvs::srv::SetBool::Request> request,
